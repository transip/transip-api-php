...
use Transip\Api\Library\Repository\Acronis\Tenant\AddonsRepository as AcronisAddonRepository;
use Transip\Api\Library\Repository\Acronis\Tenant\DowngradesRepository as AcronisDowngradesRepository;
use Transip\Api\Library\Repository\Acronis\Tenant\UpgradesRepository as AcronisUpgradesRepository;
use Transip\Api\Library\Repository\Acronis\Tenant\LoginRepository as AcronisLoginRepository;
use Transip\Api\Library\Repository\Acronis\Tenant\UsageRepository as AcronisUsageRepository;
use Transip\Api\Library\Repository\Acronis\Tenant\UsagesRepository as AcronisUsagesRepository;
use Transip\Api\Library\Repository\Acronis\TenantRepository as TenantRepository;
...
use Transip\Api\Library\Repository\Email\MailAddonRepository;
...
use Transip\Api\Library\Repository\OpenStack\Project\QuotaRepository;
...
class TransipAPI
{
    ...
    public const TRANSIP_API_LIBRARY_VERSION = "6.54.0";
    ...
    public function __construct(
        ...
        if ($cache === null && class_exists(FilesystemAdapter::class)) {
            if (function_exists('trigger_deprecation')) {
                trigger_deprecation('transip/api-library', '6.54.0', 'Not providing a cache adapter is deprecated and will throw an exception in future releases. Please provide a cache adapter implementing %s (PSR-6).', CacheItemPoolInterface::class);
            }

            $cache = new FilesystemAdapter();
        } elseif ($cache === null) {
            throw new InvalidArgumentException(sprintf(
                'No cache adapter provided and the %s class is not available. Please provide a cache adapter implementing %s (PSR-6).',
    ...
    public function objectstoreQuota(): QuotaRepository
    {
        return new QuotaRepository($this->httpClient);
    }
    ...
    public function mailAddons(): MailAddonRepository
    {
        return new MailAddonRepository($this->httpClient);
    }
    ...
    public function acronisTenants(): TenantRepository
    {
        return new TenantRepository($this->httpClient);
    }

    public function acronisAddons(): AcronisAddonRepository
    {
        return new AcronisAddonRepository($this->httpClient);
    }

    public function acronisDowngrades(): AcronisDowngradesRepository
    {
        return new AcronisDowngradesRepository($this->httpClient);
    }

    public function acronisUpgrades(): AcronisUpgradesRepository
    {
        return new AcronisUpgradesRepository($this->httpClient);
    }

    public function acronisLogin(): AcronisLoginRepository
    {
        return new AcronisLoginRepository($this->httpClient);
    }

    public function acronisUsage(): AcronisUsageRepository
    {
        return new AcronisUsageRepository($this->httpClient);
    }

    public function acronisUsages(): AcronisUsagesRepository
    {
        return new AcronisUsagesRepository($this->httpClient);
    }
